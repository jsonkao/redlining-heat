...
First, download `fullshpfile.zip` from the [Mapping Inequality](https://dsl.richmond.edu/panorama/redlining/#loc=11/40.809/-74.187&city=manhattan-ny&area=D3&text=intro) project into `data/`. Unzip it. The shapefule you want is in `fullshpfile/shapefile`. Import that in GEE.
